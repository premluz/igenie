...
export function BaseCell({ cell, children }: BaseCellProps) {
  ...
  const handleRetry = () => {
    replaceCell(cell.id, { status: 'thinking', error: undefined })
  }
